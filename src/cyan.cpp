    ...
    , profileCloseButton(Q_NULLPTR)
{
    ...
    connect(profileCloseButton, SIGNAL(released()), this, SLOT(close()));
}
...
Cyan::Cyan(QWidget *parent)
    ...
    , currentImageData(Q_NULLPTR)
    , currentImageProfile(Q_NULLPTR)
    , currentImageNewProfile(Q_NULLPTR)
